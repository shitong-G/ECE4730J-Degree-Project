#!/usr/bin/env python3
"""Run fixed baseline inference without adaptive controller."""
...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Fixed baseline RT-DETR run")
    ...
    p.add_argument("--duration-min", type=float, default=5.0)
...
def main() -> None:
    ...
    log_path = loop.run()
    print(f"Baseline run complete. Log: {log_path}")
