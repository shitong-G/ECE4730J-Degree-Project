...
def summarize(rows: list[dict[str, str]], label: str) -> dict[str, float | int | str | None]:
    ...
    return {
        ...
        "governor_applied_ratio": _bool_ratio(rows, "governor_applied"),
        "governor_apply_error_counts": _counts_json(rows, "governor_apply_error"),
        "cpu_affinity_applied_ratio": _bool_ratio(rows, "cpu_affinity_applied"),
        "cpu_affinity_apply_error_counts": _counts_json(rows, "cpu_affinity_apply_error"),
