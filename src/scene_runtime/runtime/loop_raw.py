...
class RuntimeLoop:
    ...
    def _write_log(
        ...
        record = LogRecord(
            ...
            raw_thermal_state=device_state.get("thermal_state"),
            control_thermal_state=device_state.get("thermal_state"),
            ...
            resolved_input_resolution=None,
            ...
            requested_cpu_affinity=",".join(str(cpu) for cpu in action.cpu_affinity)
            if action.cpu_affinity
            else None,
            ...
            query_budget_requested=action.query_budget,
